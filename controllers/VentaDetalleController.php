...
/**
 * VentaDetalleController implementación de las acciones CRUD en base al modelo VentaDetalle model.
 */
...
/**
* Lista todo el modelo VentaDetalle.
* @return mixed
*/
...
/**
* Muestra un modelo VentaDetalle basado en su valor de clave principal.
* @param integer $id
* @return mixed
*/
...
/**
* Crea un nuevo modelo VentaDetalle.
...
/**
* Actualiza el modelo VentaDetalle basado en su valor de clave principal.
...
/**
* Elimina el modelo VentaDetalle basado en su valor de clave principal.
...
/**
* Busca el modelo VentaDetalle basado en su valor de clave principal.
* Si no se encuentra el modelo, se lanzará una excepción de 404 HTTP.
* @param integer $id
* @return VentaDetalle retorna el modelo cargado
